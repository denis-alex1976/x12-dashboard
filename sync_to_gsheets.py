...
Без эмодзи в print() — для совместимости с cp1251.
"""
import pandas as pd
import gspread
...
KEEP_COLUMNS = [
    'Наименование хозяйства', 'Область', 'Район', 'Менеджер',
    'Вид Исследования', 'Счет, номер', 'Счет, дата', 'Счет, сумма',
    'ПП, сумма', 'ПП, дата', 'ПП, номер', 'Срок оплаты, дни',
    'цифра в зав-ти от цвета в  столбце R', 'Кол-во проб',
    'Сумма, BYN', 'Номер Протокола', 'Предприятие',
]
